        ...
        async with httpx.AsyncClient(timeout=15.0) as client:
            ...
            for field_name in sorted(all_fields):
                ...
                field_info = {
                    ...
                    "is_system": is_system_field(field_name),
...
def get_default_fields(object_type: str) -> list:
    ...
    defaults = {
        ...
        "people": [
            ...
            {"id": "profile_image", "label": "프로필 사진", "type": "url", "required": False, "is_system": False, "is_custom": False},
            {"id": "linkedin", "label": "링크드인", "type": "text", "required": False, "is_system": False, "is_custom": False},
            {"id": "unsubscribe_reason", "label": "수신 거부 사유", "type": "text", "required": False, "is_system": False, "is_custom": False},
            {"id": "recordId", "label": "RecordId", "type": "text", "required": False, "is_system": False, "is_custom": False},
            {"id": "unsubscribed", "label": "수신 거부 여부", "type": "boolean", "required": False, "is_system": False, "is_custom": False},
            {"id": "source", "label": "소스", "type": "select", "required": False, "is_system": False, "is_custom": False},
            {"id": "journey_stage", "label": "고객 여정 단계", "type": "select", "required": False, "is_system": False, "is_custom": False},
            {"id": "owner", "label": "담당자", "type": "user", "required": False, "is_system": False, "is_custom": False},
            {"id": "customer_group", "label": "고객 그룹", "type": "multiselect", "required": False, "is_system": False, "is_custom": False},
        ],
        # 회사 (Organization) - Import 가능 필드
        "company": [
            {"id": "name", "label": "이름", "type": "text", "required": True, "is_system": False, "is_custom": False},
            {"id": "profile_image", "label": "프로필 사진", "type": "url", "required": False, "is_system": False, "is_custom": False},
            {"id": "address", "label": "주소", "type": "text", "required": False, "is_system": False, "is_custom": False},
            {"id": "phone", "label": "전화", "type": "text", "required": False, "is_system": False, "is_custom": False},
            {"id": "website", "label": "웹 주소", "type": "url", "required": False, "is_system": False, "is_custom": False},
            {"id": "linkedin", "label": "링크드인", "type": "text", "required": False, "is_system": False, "is_custom": False},
            {"id": "recordId", "label": "RecordId", "type": "text", "required": False, "is_system": False, "is_custom": False},
            {"id": "employee_count", "label": "직원수", "type": "number", "required": False, "is_system": False, "is_custom": False},
            {"id": "owner", "label": "담당자", "type": "user", "required": False, "is_system": False, "is_custom": False},
        ],
        # 리드 (Lead) - Import 가능 필드
        "lead": [
            {"id": "name", "label": "이름", "type": "text", "required": True, "is_system": False, "is_custom": False},
            {"id": "hold_detail_reason", "label": "보류 상세 사유", "type": "text", "required": False, "is_system": False, "is_custom": False},
            {"id": "recordId", "label": "RecordId", "type": "text", "required": False, "is_system": False, "is_custom": False},
            {"id": "amount", "label": "금액", "type": "number", "required": False, "is_system": False, "is_custom": False},
            {"id": "lead_type", "label": "유형", "type": "select", "required": False, "is_system": False, "is_custom": False},
            {"id": "status", "label": "상태", "type": "select", "required": False, "is_system": False, "is_custom": False},
            {"id": "hold_reason", "label": "보류 사유", "type": "select", "required": False, "is_system": False, "is_custom": False},
            {"id": "expected_date", "label": "수주 예정일", "type": "datetime", "required": False, "is_system": False, "is_custom": False},
            {"id": "owner", "label": "담당자", "type": "user", "required": False, "is_system": False, "is_custom": False},
            {"id": "followers", "label": "팔로워", "type": "users", "required": False, "is_system": False, "is_custom": False},
            {"id": "pipeline", "label": "파이프라인", "type": "pipeline", "required": False, "is_system": False, "is_custom": False},
            {"id": "pipeline_stage", "label": "파이프라인 단계", "type": "pipeline_stage", "required": False, "is_system": False, "is_custom": False},
            {"id": "lead_group", "label": "리드 그룹", "type": "multiselect", "required": False, "is_system": False, "is_custom": False},
            {"id": "main_quote_products", "label": "메인 견적 상품 리스트", "type": "multiselect", "required": False, "is_system": False, "is_custom": False},
        ],
        # 딜 (Deal) - Import 가능 필드
        "deal": [
            {"id": "name", "label": "이름", "type": "text", "required": True, "is_system": False, "is_custom": False},
            {"id": "fail_detail_reason", "label": "실패 상세 사유", "type": "text", "required": False, "is_system": False, "is_custom": False},
            {"id": "recordId", "label": "RecordId", "type": "text", "required": False, "is_system": False, "is_custom": False},
            {"id": "amount", "label": "금액", "type": "number", "required": False, "is_system": False, "is_custom": False},
            {"id": "monthly_amount", "label": "월 구독 금액", "type": "number", "required": False, "is_system": False, "is_custom": False},
            {"id": "status", "label": "상태", "type": "select", "required": False, "is_system": False, "is_custom": False},
            {"id": "fail_reason", "label": "실패 사유", "type": "multiselect", "required": False, "is_system": False, "is_custom": False},
            {"id": "subscription_end_type", "label": "구독 종료 유형", "type": "select", "required": False, "is_system": False, "is_custom": False},
            {"id": "subscription_start_type", "label": "구독 시작 유형", "type": "select", "required": False, "is_system": False, "is_custom": False},
            {"id": "expected_date", "label": "수주 예정일", "type": "datetime", "required": False, "is_system": False, "is_custom": False},
            {"id": "close_date", "label": "마감일", "type": "datetime", "required": False, "is_system": False, "is_custom": False},
            {"id": "subscription_end", "label": "구독 종료일", "type": "datetime", "required": False, "is_system": False, "is_custom": False},
            {"id": "subscription_start", "label": "구독 시작일", "type": "datetime", "required": False, "is_system": False, "is_custom": False},
            {"id": "owner", "label": "담당자", "type": "user", "required": False, "is_system": False, "is_custom": False},
            {"id": "followers", "label": "팔로워", "type": "users", "required": False, "is_system": False, "is_custom": False},
            {"id": "pipeline", "label": "파이프라인", "type": "pipeline", "required": False, "is_system": False, "is_custom": False},
            {"id": "pipeline_stage", "label": "파이프라인 단계", "type": "pipeline_stage", "required": False, "is_system": False, "is_custom": False},
